...
st.title("CrewAI Multi-Agent Workforce Forecasting Prototype 2012")
...
if run_clicked:
    ...
    st.caption(f"Risk Pressure: {primary_risk_value:.1f}%")
    ...
    if rec is not None:
        ...
        with title_col:
            st.markdown("### CrewAI Operational Analysis")
        ...
        st.info(
            "LangGraph workflow active: Forecast Node → Staffing Node → Cost Node → Executive Summary Node → Operational Memory"
        )
